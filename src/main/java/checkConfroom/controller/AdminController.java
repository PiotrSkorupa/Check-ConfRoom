...
import checkConfroom.service.UserService;
...
@Controller
@RequestMapping("/check-confroom/admin")
public class AdminController {
    ...
    public String saveUser(@Valid @ModelAttribute("user") UserDto user, BindingResult bindingResult) {
        ...
        return "redirect:/check-confroom/admin/showUser";
    }
    ...
    public String showUser(Model model) {
        ...
        for (User e : users) {
            ...
            for (UserRole userRole : userRoleList) {
                ...
                userDto.add(new UserDto(e.getUserId(), e.getUserName(), e.getPassword(), e.getEmail(), userRoles));
            }
        }
